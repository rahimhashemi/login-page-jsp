<%@ page import="com.behsazan.bbanking.common.constants.MessageConstants" %>
<%@ page import="com.behsazan.common.util.BundleUtils" %>
<%@ page import="com.behsazan.common.util.DateTimeUtil" %>
<%@ page import="org.springframework.security.core.Authentication" %>
<%@ page import="org.springframework.security.core.context.SecurityContext" %>
<%@ page import="org.springframework.security.core.context.SecurityContextHolder" %>
<%@ page import="server.com.behsazan.bbanking.security.CustomUserAuthentication" %>
<%@ page import="server.com.behsazan.bbanking.captcha.CaptchaServlet" %>
...
<head>
    <title>بانکداري اينترنتي بانک ملت </title>
    <link rel="stylesheet" type="text/css" href="style/virtualKeyboard.css">
    <link rel="shortcut icon" href="images/favicon.ico">
    <script type="text/javascript" src="script/virtualkeyboard.js"></script>
</head>

<%
    String validationMsg = ((request.getAttribute("validationError") != null) ? (String) request.getAttribute("validationError") : "");
    SecurityContext context = SecurityContextHolder.getContext();
    if (context != null) {
        Authentication authentication =
                context.getAuthentication();
        if (authentication != null && authentication instanceof CustomUserAuthentication) {
            response.sendRedirect("index");
//            response.sendRedirect("index.jsp");
        }
    }
    BundleUtils bundle = BundleUtils.getInstance("fa", "IR", MessageConstants.MESSAGE_RESOURCE_BUNDLE_PATH);
%>
...
<style>
    ...
    .border_right_left {
        width: 1px;
        background-image: url(images/bg_border_right_left.png);
        background-position: center;
        background-repeat: inherit;
    }

    .left_border_1 {
        background-image: url(images/bg_left_border_1.png);
        background-position: center;
    ...
    /*//behavior: url('/ebanking/styles/ie-css3.htc');*/
    /*}*/
            ...
            <div id="header" class="header" align="center" style="width:1000px">
                ...
                <div dir="<bean:message key="common.dir.ltr"/>">
                    <input
                            ...
                            type="text" value="<%=DateTimeUtil.getTodayDateStr()%>">
                            ...
                            <tr class="Left_Right">
                                ...
                                <td width="958px;" style="background-color:#f3f3f3;">
                                    ...
                                    <div id="middleSection" style="height:auto; margin: 0 0 0 0 ;padding: 0 0 0 0;">
                                        <table cellspacing="0px" width="958px" style="height:365px; max-width: 958px;"
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" border="0"
                                                            ...
                                                            <tr>
                                                                <td align="center" valign="top">
                                                                    <div id="loginForm2" class="loginFormBoxes" style="background-color: #f3f3f3;border-bottom-right-radius: 0px; width: 100%;
                                                                                        border-bottom-left-radius: 0px; ">
                                                                        <table cellpadding="0" cellspacing="0"
                                                                            ...
                                                                            <tr>
                                                                                <td align="center"
                                                                                    ...
                                                                                    <%
                                                                                        if (request.getAttribute("validationError") != null || !validationMsg.equals("")) {
                                                                                    ...
                                                                                    <form id="loginForm"
                                                                                        ...
                                                                                        <table align="center"
                                                                                            ...
                                                                                            <%
                                                                                                ...
                                                                                                try {
                                                                                                    captchaUrl = CaptchaServlet.generateCaptchaUrl(request1);
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td style="padding-right: 50px"
                                                                                                    align="right"
                                                                                                    dir="rtl">&nbsp;
                                                                                                    <img src="CaptchaServlet/<%=captchaUrl%>"
                                                                                                         id="captchaImg"
                                                                                                         border="0"
                                                                                                         align="right"
                                                                                                         alt="Captcha"/>
...
border-bottom-left-radius: 0px;">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="40%">
                                                                        <a class="boldLabel2" style="padding:0;"
                                                                           ...
                                                                           title="<bean:message key="quickLinks.clickMe"/>">
                                                                            <bean:message key="quickLinks.tej1.title"/>
                                                                        </a>
                                                                    ...
                                                                    <td>
                                                                        <a class="boldLabel2" style="padding:0;"
                                                                           ...
                                                                           target="_blank"
                                                                           title="<bean:message key="quickLinks.clickMe"/>">
                                                                            <bean:message key="quickLinks.tej2.title"/>
                                                                        </a>
                                                                    </td>
                                                                    <td width="7px" valign="middle">
                                                                        <img src="images/quick_bullet_fa.gif"
        ...
        <div id="footer" class="footer" style="text-align:center;">
            ...
            &nbsp;<font color="white">|</font>&nbsp;
            <a class="boldLabel1" style="color:white;" target="_blank" href="http://www.cyberpolice.ir"><bean:message
...
<script type="text/javascript" language="javascript">
    ...
    function alertEnglishOnKeyPress(e, obj) {
        if (!isEnglishNumberKeysPressed(e)) {
            alert('<%=bundle.getMessage("error.requestAccount.textIsNotEnglish")%>');
            obj.focus();
            return false;
        }
        return true;
    ...
    function checkChars(str, en, fa, num, space) {

        var farsiChars = 'آابپتثجچحخدذرزژسشصضطظعغفقکگلمنوهييیيءأئئءأووؤإئةك';
        var englishChars = 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ_-';
        ...
        for (i = 0; i < str.length; ++i) {
            ...
            if (space && charAt == ' ')continue;
            if (en) {
                if (englishChars.indexOf(charAt) >= 0)ok = 1;
            }
            if (fa) {
                if (farsiChars.indexOf(charAt) >= 0)ok = 1;
            }
            if (num) {
                if (numberChars.indexOf(charAt) >= 0)ok = 1;
            }
    ...
    function preventFarsi(e, obj) {
        if (isFarsiKeysPressed(e)) {
            alert('<%=bundle.getMessage("common.alert.nofarsikeyboard")%>');
            obj.focus();
            return false;
        }
        return true;
    ...
    function validateForm() {
        ...
        if (document.loginForm.j_username.value == document.loginForm.j_password.value) {
            alert("نام کاربری و کلمه عبور نمی توانند با هم برابر باشند");
            document.loginForm.j_username.focus();
            return false;
        }
        if (document.loginForm.j_username.value.length < 8 || document.loginForm.j_username.value.length > 20) {
            alert("نام کاربری باید حداقل 8 و حداکثر 20  حرف باشد ");
            document.loginForm.j_username.focus();
            return false;
        }
        if (!checkChars(document.loginForm.j_username.value, true, false, true, false)) {
            alert("نام کاربری باید فقط شامل حروف انگلیسی و عدد  باشد");
            document.loginForm.j_username.focus();
            return false;
        }
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        if (document.loginForm.j_password.value.length < 8 || document.loginForm.j_password.value.length > 15) {
            alert("کلمه عبور باید حداقل 8 و حداکثر 15 حرف  باشد ");
            document.loginForm.j_password.focus();
            return false;
        }
        if (!checkChars(document.loginForm.j_password.value, true, false, true, false)) {
            alert("کلمه عبور باید فقط شامل حروف انگلیسی و عدد  باشد");
            document.loginForm.j_username.focus();
            return false;
        }

        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        if (document.loginForm.captcha.value.length == 0) {
            alert("لطفا عبارت امنیتی را وارد کنید");
            document.loginForm.captcha.focus();
            return false;
        }
        disableFormSubmit(document.frm);
        return true;
    }
    ...
    function validateloginForm() {
        ...
        if (userId.length > 20 || (userId.length > 0 && userId.length < 8)) {
            alert("نام کاربری باید حداقل 8 و حداکثر 20  حرف باشد ");
            document.loginForm.j_username.focus();
            return false;
        }

        if (!checkChars(userId, true, false, true, false)) {
            alert("نام کاربری باید فقط شامل حروف انگلیسی و عدد  باشد");
            document.loginForm.j_username.focus();
            return false;
        }
        ...
        if (document.loginForm.textPattern.value == "") {
            alert("لطفا عبارت امنیتی را وارد کنید");
            document.loginForm.textPattern.focus();
            return false;
        }

        if (document.loginForm.textPattern.value.length != 4) {
            alert("<bean:message key="error.login.SecurityCodeInvalid"/>");
            document.loginForm.textPattern.focus();
            return false;
        }
    ...
    function disableFormSubmit(form) {
        ...
        var submit1 = form.elements["submit1"];
        var cancel = form.elements["cancel"];
        var edit = form.elements["edit"];

        if (submit1 != null && submit1.type != "hidden" && !submit1.disabled) {
            submit1.disabled = true;
            submit1.title = "<bean:message key="common.pleaseWait"/>";
        }

        if (cancel != null && cancel.type != "hidden" && !cancel.disabled) {
            cancel.disabled = true;
        }

        if (edit != null && edit.type != "hidden" && !edit.disabled) {
            edit.disabled = true;
        }
        return true;
    }
